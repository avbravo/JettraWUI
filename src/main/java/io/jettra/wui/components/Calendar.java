...
public class Calendar extends UIComponent {
    ...
    public String render() {
        ...
        // Methods attached to DOM element
        html.append("  calEl._prevMonth = function() { currentMonth--; if(currentMonth < 0) { currentMonth=11; currentYear--; } renderCalendar(currentMonth, currentYear); };\n");
        html.append("  calEl._nextMonth = function() { currentMonth++; if(currentMonth > 11) { currentMonth=0; currentYear++; } renderCalendar(currentMonth, currentYear); };\n");
